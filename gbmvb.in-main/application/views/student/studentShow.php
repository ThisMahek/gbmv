            ...
            <div class="col-md-9">
                <div class="nav-tabs-custom">
                    <ul class="nav nav-tabs">
                        ...
                        <?php
                        if(check_delete($type_s,'student_details')==1)
                        {
                        ?>
                        ...
                        <div class="tab-pane active" id="activity">
                                ...
                                <div class="table-responsive around10 pt0">
                                    <table class="table table-hover table-striped tmb0">
                                        <tbody>  
                                            ...
                                            <tr>
                                                <td><b><?php echo $this->lang->line('mobile_no'); ?></b></td>
                                                <td><?php echo $student['mobileno']; ?></td>
                                            </tr>
                                            <tr>
                                                <td><b><?php echo $this->lang->line('cast'); ?></b></td>
                                                <td><?php echo $student['cast']; ?></td>
                                            </tr>
                                            <tr>
                                                <td><b><?php echo $this->lang->line('religion'); ?></b></td>
                                                <td><?php echo $student['religion']; ?></td>
                                            </tr>
                                            <tr>
                                                <td><b><?php echo $this->lang->line('email'); ?></b></td>
                            ...
                            <div class="tshadow mb25 bozero">   
                                ...
                                <div class="table-responsive around10 pt0">  
                                    <table class="table table-hover table-striped tmb0"><tbody>
                                            <tr>
                                                <td><b><?php echo $this->lang->line('current_address'); ?></b></td>
                                                <td><?php echo $student['current_address']; ?></td>
                                            </tr>
                                            <tr>
                                                <td><b><?php echo $this->lang->line('permanent_address'); ?></b></td>
                            ...
                            <div class="tshadow mb25 bozero">      
                                ...
                                <div class="table-responsive around10 pt10">
                                    <table class="table table-hover table-striped tmb0">
                                        <tr>
                                            <td  class="col-md-4"><b><?php echo $this->lang->line('father_name'); ?></b></td>
                                            <td  class="col-md-5"><?php echo $student['father_name']; ?></td>
                                        </tr>
                                        <tr>
                                            <td><b><?php echo $this->lang->line('father_phone'); ?></b></td>
                                            <td><?php echo $student['father_phone']; ?></td>
                                        </tr>
                                        <tr>
                                            <td><b><?php echo $this->lang->line('father_occupation'); ?></b></td>
                                            <td><?php echo $student['father_occupation']; ?></td>
                                        </tr>
                                        <tr>
                                            <td><b><?php echo $this->lang->line('mother_name'); ?></b></td>
                                            <td><?php echo $student['mother_name']; ?></td>
                                        </tr>
                                        <tr>
                                            <td><b><?php echo $this->lang->line('mother_phone'); ?></b></td>
                                            <td><?php echo $student['mother_phone']; ?></td>
                                        </tr>
                                        <tr>
                                            <td><b><?php echo $this->lang->line('mother_occupation'); ?></b></td>
                                            <td><?php echo $student['mother_occupation']; ?></td>
                                        </tr>
                                        <tr>
                                            <td><b><?php echo $this->lang->line('guardian_name'); ?></b></td>
                                            <td><?php echo $student['guardian_name']; ?></td>
                                        </tr>
                                        <tr>
                                            <td><b><?php echo $this->lang->line('guardian_email'); ?></b></td>
                                            <td><?php echo $student['guardian_email']; ?></td>
                                        </tr>
                                        <tr>
                                            <td><b><?php echo $this->lang->line('guardian_relation'); ?></b></td>
                                            <td><?php echo $student['guardian_relation']; ?></td>
                                        </tr>
                                        <tr>
                                            <td><b><?php echo $this->lang->line('guardian_phone'); ?></b></td>
                                            <td><?php echo $student['guardian_phone']; ?></td>
                                        </tr>
                                        <tr>
                                            <td><b><?php echo $this->lang->line('guardian_occupation'); ?></b></td>
                                            <td><?php echo $student['guardian_occupation']; ?></td>
                                        </tr>
                                        <tr>
                                            <td><b><?php echo $this->lang->line('guardian_address'); ?></b></td>
                            ...
                            <div class="tshadow mb25  bozero">    
                                ...
                                <div class="table-responsive around10 pt0">
                                    <table class="table table-hover table-striped tmb0">
                                        <tbody>
                                            <tr>
                                                <td  class="col-md-4"><b><?php echo $this->lang->line('previous_school_details'); ?></b></td>
                                                <td  class="col-md-5"><?php echo $student['previous_school']; ?></td>
                                            </tr>
                                            <tr>
                                                <td  class="col-md-4"><b><?php echo $this->lang->line('national_identification_no'); ?></b></td>
                                                <td  class="col-md-5"><?php echo $student['adhar_no']; ?></td>
                                            </tr>
                                            <tr>
                                                <td><b><?php echo $this->lang->line('local_identification_no'); ?></b></td>
                                                <td><?php echo $student['samagra_id']; ?></td>
                                            </tr>
                                            <tr>
                                                <td><b><?php echo $this->lang->line('bank_account_no'); ?><b></td>
                                                <td><?php echo $student['bank_account_no']; ?></td>
                                            </tr>
                                            <tr>
                                                <td><b><?php echo $this->lang->line('bank_name'); ?><b></td>
                                                <td><?php echo $student['bank_name']; ?></td>
                                            </tr>
                                            <tr>
                                                <td><b><?php echo $this->lang->line('ifsc_code'); ?></b></td>
