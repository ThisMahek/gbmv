                ...
                <div class="box box-primary">
                    ...
                    <div class="box-body">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="row">
                                    <form role="form" action="<?php echo site_url()?>student/search/<?php echo $type_s=='admin'?'admin':'accountant' ?>" method="post" class="">
                                        ...
                                        if (empty($resultlist)) {
                                            ...
                                            foreach ($resultlist as $student) {
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="pull-right">
                                                        <a href="<?php echo base_url(); ?>student/view/<?php echo $student['id'] ?>/<?php echo $type_s=='admin'?'admin':'accountant' ?>" class="btn btn-default btn-xs"  data-toggle="tooltip" title="<?php echo $this->lang->line('show'); ?>" >
                                                     ...
                                                     {
                                                     ?>
                                                        <a href="<?php echo base_url(); ?>student/edit/<?php echo $student['id'] ?>/<?php echo $type_s=='admin'?'admin':'accountant' ?>" class="btn btn-default btn-xs"  data-toggle="tooltip" title="<?php echo $this->lang->line('edit'); ?>">
                                                            <i class="fa fa-pencil"></i>
                                                        </a>
                                                        
                                                        <?php }?>
                                                
                                                        <!--<a  target="_blank" href="<?php echo base_url(); ?>studentfee/addfee/<?php echo $student['id'] ?>/<?php echo $type_s=='admin'?'admin':'accountant' ?>" class="btn btn-default btn-xs" data-toggle="tooltip" title="" data-original-title="<?php echo $this->lang->line('add_fees'); ?>">-->
