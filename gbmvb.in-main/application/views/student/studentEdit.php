                                    ...
                                    <div class="row">
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <input autofocus="" id="admission_no" name="admission_no" placeholder="" type="text" class="form-control"  value="<?php echo set_value('admission_no', $student['admission_no']); ?>" readonly />
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                <label for="exampleInputEmail1"><?php echo $this->lang->line('date_of_birth'); ?></label>
                                                   <input id="dob_" name="dob"  type="date" class="form-control"  max="<?=date('Y-m-d')?>" value="<?=date('Y-m-d',strtotime($student['dob'] ))?>" />
                                         ...
                                         <div class="col-md-3">
                                            ...
                                            <option value=""><?php echo $this->lang->line('select'); ?></option>
                                                    ...
                                                    foreach ($subjectlist as $subject) {
                                                        ...
                                                        if ($student['subject_id'] == $subject['id']) {
                                                            echo "selected =selected";
                                                        }
