            ...
            <div class="col-md-12">
                <div class="box box-primary">
                    <div class="pull-right box-tools" style="position: absolute;right: 14px;top: 13px;">
                        <a href="<?php echo site_url()?>student/import/<?php echo $type_s=='admin'?'admin':'accountant' ?>">
                            <button class="btn btn-primary btn-sm"><i class="fa fa-upload"></i> <?php echo $this->lang->line('import_student'); ?></button>
                        </a>
                    </div>

                    <form id="form1" action="<?php echo site_url() ?>student/create/<?php echo $type_s=='admin'?'admin':'accountant' ?>"  id="employeeform" name="employeeform" method="post" accept-charset="utf-8" enctype="multipart/form-data">
                        <div class="box-body">
