                                        ...
                                        foreach ($categorylist as $category) {
                                            ...
                                            <tr>                                               
                                                ...
                                                <td class="mailbox-date pull-right no-print">
                                                    <a href="<?php echo base_url(); ?>admin/expensehead/edit/<?php echo $category['id'] ?>" class="btn btn-default btn-xs" data-placement="left" data-toggle="tooltip" title="<?php echo $this->lang->line('edit'); ?>">
                                                        <i class="fa fa-pencil"></i>
                                                    </a>
                                                    <a href="<?php echo base_url(); ?>admin/expensehead/delete/<?php echo $category['id'] ?>"class="btn btn-default btn-xs" data-placement="left" data-toggle="tooltip" title="<?php echo $this->lang->line('delete'); ?>" onclick="return confirm('Are you sure you want to delete this item?');">
