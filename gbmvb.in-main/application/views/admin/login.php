...
<html lang="en">
    <head><meta http-equiv="Content-Type" content="text/html; charset=utf-8">
        ...
        <title>Gautam Buddh Mahavidyalaya : School Management System</title>
        <!--favican-->
            ...
            <div class="inner-bg">
                <div class="container">
                    <div class="row">
                        ...
                        <!--    <img src="<?php echo base_url(); ?>backend/images/IMG_5168.jpg">-->
                        <!--</div>-->
                    </div>
                    <div class="row">
                        <div class="col-sm-6 col-sm-offset-3 form-box">
                            <div class="form-top parimary">
                                 <center>
                                    <img src="<?php echo base_url(); ?>/uploads/school_content/logo/<?php echo $this->setting_model->getSchoolLogo();?>" class="logowidth">
                                    <h3 class="font-black"><?php echo $this->lang->line('admin_login'); ?></h3>
                                </center>
                            ...
                            <div class="form-bottom parimary">
                                <?php
                                ...
                                <form action="<?php echo site_url('site/login') ?>" method="post">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="username" value="anshuwap1@gmail.com" placeholder="<?php echo $this->lang->line('username'); ?>"  class="form-username form-control" id="form-username">
                                    ...
                                    <button type="submit" class="btn secondary_color"><?php echo $this->lang->line('sign_in'); ?></button>
                                </form>
