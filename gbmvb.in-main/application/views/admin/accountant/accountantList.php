                    ...
                    <form id="form1" action="<?php echo site_url('admin/accountant/index') ?>"  id="employeeform" name="employeeform" method="post" accept-charset="utf-8"  enctype="multipart/form-data">
                        <div class="box-body">
                            ...
                            <div class="form-group">
                                ...
                                <input id="dob_" name="dob" placeholder="" type="date" class="form-control"  max="<?=date('Y-m-d')?>"/>
                            ...
                            <div class="form-group">
                                ...
                                <input id="phone_1" name="phone" placeholder="" type="text" class="form-control" onkeypress="return (event.charCode > 47 && event.charCode < 58)" maxlength="10" oninput="validateMobile('phone_1','sp_mobile','btn_1')" value="<?php echo set_value('phone'); ?>" />
                                <span class="text-danger"><?php echo form_error('phone'); ?></span>
                                 <span id="sp_mobile" style="color:red"></span>
                            </div>
                            <div class="form-group">
                                <label for="father_name"><?php echo $this->lang->line('father_name'); ?></label>
                                <input id="phone" name="father_name" placeholder="" type="text" class="form-control"  value="<?php echo set_value('father_name'); ?>" />
                                <span class="text-danger"><?php echo form_error('father_name'); ?></span>
                            </div>
                            <div class="form-group">
                                <label for="department"><?php echo $this->lang->line('department'); ?>Department</label>
                                <input id="phone" name="department" placeholder="" type="text" class="form-control"  value="<?php echo set_value('department'); ?>" />
                        ...
                        <div class="box-footer">
                            <button type="submit" id="btn_1" class="btn btn-info pull-right"><?php echo $this->lang->line('save'); ?></button>
                        </div>
                    </form>
                </div>   
            </div>  
                                    ...
                                    <tr>
                                        ...
                                        <th><?php echo $this->lang->line('phone'); ?></th>
                                          <th><?php echo $this->lang->line('father_name'); ?></th>
                                            <th><?php echo $this->lang->line('departmant'); ?>Departmant</th>
                                        ...
                                        foreach ($librarianlist as $librarian) {
                                            ...
                                            <tr>
                                                ...
                                                <td class="mailbox-name"> <?php echo $librarian['phone'] ?></td>
                                                  <td class="mailbox-name"> <?php echo $librarian['father_name'] ?></td>
                                                    <td class="mailbox-name"> <?php echo $librarian['department'] ?></td>
                                                <td class="mailbox-date pull-right no-print flex_class">
