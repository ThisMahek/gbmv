                ...
                <div class="container">
                    <div class="row">
                        <div class="col-sm-8 col-sm-offset-2 text">
                            <img src="<?php echo base_url(); ?>/uploads/school_content/logo/<?php echo $this->setting_model->getSchoolLogo();?>" style="height:200px;" class="logo_img">
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-sm-6 col-sm-offset-3 form-box">
                            ...
                            <div class="form-bottom parimary">
                                ...
                                <form action="<?php echo site_url('site/forgotpassword') ?>" method="post">
                                    ...
                                    <button type="submit" class="btn secondary_color"><?php echo $this->lang->line('submit'); ?></button>
                                </form>
