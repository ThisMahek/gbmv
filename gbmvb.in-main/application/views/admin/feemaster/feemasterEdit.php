                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <!--<?php echo $feegroup_type->due_date?>-->
                                         <input id="due_date_" name="due_date" placeholder="" type="date" class="form-control"  min="<?=date('Y-m-d')?>"  value="<?php echo date('Y-m-d',strtotime($feegroup_type->due_date)) ?>" />
                                        <!--<input id="due_date" name="due_date" placeholder="" type="text" class="form-control"  value="<?php echo $this->customlib->dateyyyymmddTodateformat($feegroup_type->due_date); ?>" >-->
                                                ...
                                                <ul class="liststyle1">
                                                    ...
                                                    foreach ($feegroup->feetypes as $feetype_key => $feetype_value) {
                                                        ...
                                                        <li> <i class="fa fa-money"></i>  
                                                            <?php echo $feetype_value->type . " " . $currency_symbol . $feetype_value->amount; ?> &nbsp;&nbsp;
