...
.material-switch > label::before {
    background: rgb(108 147 235)!important;
...
.custum-chart-width .chart canvas{
    ...
    <body class="hold-transition skin-blue fixed sidebar-mini">
        <div class="wrapper">
            <header class="main-header" id="alert">            
                <a href="<?php echo base_url(); ?>admin/admin/dashboard" class="logo secondary_color">                 
                    <span class="logo-mini">S S</span>                 
                    <span class="logo-lg"><img src="<?php echo base_url(); ?>/uploads/school_content/logo/<?php echo $this->setting_model->getSchoolLogo();?>" style="width:auto;height:50px;border-radius: 47%;" alt="<?php echo $this->customlib->getAppName() ?>" /></span>
                </a>             
                <nav class="navbar navbar-static-top secondary_color" role="navigation">                  
    ...
    <section class="sidebar tab_side" id="sibe-box">
        ...
        <ul class="sessionul fixedmenu">
            ...
            <li class="dropdown">
                ...
                <ul class="dropdown-menu verticalmenu" style="min-width:194px;font-size:10pt;left:3px;">
                    <li role="presentation"><a style="color:#282828; font-weight:600;padding:6px 20px;" role="menuitem" tabindex="-1" href="<?php echo base_url(); ?>student/search/admin"><i class="fa fa-user-plus"></i><?php echo $this->lang->line('student_details'); ?></a></li>
        ...
        <ul class="sidebar-menu verttop">
            <li class="treeview <?php echo set_Topmenu('Student Information'); ?>">
                ...
                <ul class="treeview-menu">
                     <li class="<?php echo set_Submenu('student/create'); ?>"><a href="<?php echo base_url(); ?>student/create/admin"><i class="fa fa-angle-double-right"></i> <?php echo $this->lang->line('student_admission'); ?></a></li>
                    <li class="<?php echo set_Submenu('student/search'); ?>"><a href="<?php echo base_url(); ?>student/search/admin"><i class="fa fa-angle-double-right"></i> <?php echo $this->lang->line('student_details'); ?></a></li>
                   
                    <li class="<?php echo set_Submenu('category/index'); ?>"><a href="<?php echo base_url(); ?>category/index"><i class="fa fa-angle-double-right"></i> <?php echo $this->lang->line('student_categories'); ?></a></li>
                    <li class="<?php echo set_Submenu('stdtransfer/index'); ?>"><a href="<?php echo base_url(); ?>admin/stdtransfer/index/admin"><i class="fa fa-angle-double-right"></i> <?php echo $this->lang->line('promote_students'); ?></a></li>
                </ul>
            </li>
