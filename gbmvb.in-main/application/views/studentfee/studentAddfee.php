...
<div class="modal fade" id="myFeesModal" role="dialog">
    <div class="modal-dialog">      
        <div class="modal-content">
            <div class="modal-header secondary_color">
                        ...
                        <div class="form-group mb0">
                            ...
                            <div class="col-sm-9">
                                ...
                                <div class="col-md-12 col-sm-12">
                                    <div class="form-group">
                                        <input type="number" min="1" class="form-control" id="amount_discount" value="0" oninput="validateDiscountAmount()">

                                        <span class="text-danger" id="amount_error"></span>
                                         <span class="text-danger" id="sp6" style="color:red"></span>
                                        </div>
                                </div> 
            ...
            <div class="modal-footer">
                <div class="box-body">
                    ...
                    <button type="button" class="btn cfees save_button secondary_color" id="load" data-loading-text="<i class='fa fa-circle-o-notch fa-spin'></i> Processing"> <?php echo $currency_symbol; ?> <?php echo $this->lang->line('collect_fees'); ?> </button>
                </div>
            </div>
        </div>
 ...
 function validateDiscountAmount()
      {
        ...
        // else
        // {
        //                 document.getElementById("sp6").innerHTML="Invaild discount amount,amount must be grater than or equal 0!";
        //                 // document.getElementById("sp6").style.color="red";
        //     document.getElementById("load").disabled=true;
        // }
      }
