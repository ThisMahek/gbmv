        ...
        <div class="row">           
            <div class="col-md-12">
                <div class="box box-primary">
                    ...
                    <form id='form1' action="<?php echo site_url()?>accountant/stdtransfer/index/accountant"  method="post" accept-charset="utf-8">
                        <div class="box-body">
                        ...
                        <div class="box-footer">
                                                        <div class="form-group">
                                                <button type="submit" name="search" value="search_filter" class="btn btn-primary btn-sm pull-right checkbox-toggle"><i class="fa fa-search"></i> <?php echo $this->lang->line('array_search(needle, haystack)'); ?><?php echo $this->lang->line('search'); ?></
                                            </div>
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        $('#pramoteStudentModal').on('click', '.pramote_student', function (e) {
            ...
            // alert(datastring);
            // alert(class_promote);
            // alert(section_promote);
            // alert(class_post);
            
            $.ajax({
                type: "POST",

                url: '<?php echo site_url("accountant/stdtransfer/promote") ?>',
