                ...
                <div class="box box-primary">
                    <div class="box-header with-border">
                        ...
                        <div class="pull-right box-tools">                            
                            <a href="<?php echo site_url('accountant/student/exportformat') ?>">
                                <button class="btn btn-primary btn-sm"><i class="fa fa-download"></i> <?php echo $this->lang->line('dl_sample_import'); ?></button>
                            </a>
                        </div>
                    </div>
                    <form action="<?php echo site_url()?>accountant/student/import/accountant"  id="employeeform" name="employeeform" method="post" enctype="multipart/form-data">
                        <div class="box-body">
