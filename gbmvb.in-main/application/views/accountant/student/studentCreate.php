            ...
            <div class="col-md-12">
                <div class="box box-primary">
                    <div class="pull-right box-tools" style="position: absolute;right: 14px;top: 13px;">
                        <a href="<?php echo site_url()?>accountant/student/import/<?php echo $type_s=='admin'?'admin':'accountant' ?>">
                            <button class="btn btn-primary btn-sm"><i class="fa fa-upload"></i> <?php echo $this->lang->line('import_student'); ?></button>
                        </a>
                    </div>

                    <form id="form1" action="<?php echo site_url() ?>accountant/student/create/accountant"  id="employeeform" name="employeeform" method="post" accept-charset="utf-8" enctype="multipart/form-data">
                        <div class="box-body">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <input id="firstname" name="firstname" placeholder="" type="text" class="form-control" onkeypress="return (event.charCode > 64 && event.charCode < 91) || (event.charCode > 96 && event.charCode < 123) || (event.charCode==32)" value="<?php echo set_value('firstname'); ?>" />
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <input id="lastname" name="lastname" placeholder="" type="text" class="form-control" onkeypress="return (event.charCode > 64 && event.charCode < 91) || (event.charCode > 96 && event.charCode < 123) || (event.charCode==32)" value="<?php echo set_value('lastname'); ?>" />
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <input id="dob_" name="dob"  type="date" class="form-control"  max="<?=date('Y-m-d')?>" />
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <input id="mobileno" name="mobileno" placeholder="" type="text" class="form-control" maxlength="10"  oninput="validateMobile('mobileno','sp_mobile1','btn')"  onkeypress="return (event.charCode > 47 && event.charCode < 58)" value="<?php echo set_value('mobileno'); ?>" />
                                                <span class="text-danger"><?php echo form_error('mobileno'); ?></span>
                                                 <span id="sp_mobile1" style="color:red"></span>
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <input id="email" name="email" placeholder="" type="text" class="form-control" oninput="validateGmail('email','sp_email','btn')" value="<?php echo set_value('email'); ?>" />
                                                <span class="text-danger"><?php echo form_error('email'); ?></span>
                                                <span id="sp_email" style="color:red"></span>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                            ...
                                            <div class="form-group">
                                              ...
                                              <option value=""><?php echo $this->lang->line('select'); ?></option>
                                                    ...
                                                    foreach ($subjectlist as $subject) {
                                                        ?>
                                                        <option value="<?php echo $subject['id'] ?>"<?php if (set_value('subject_id') == $subject['id']) echo "selected=selected" ?>><?php echo $subject['name'] ?></option>
                                                        <?php
                                                        $count++;
                                                    }
                                                    ?>
                                    ...
                                    <div class="row">
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <input id="father_name" name="father_name" placeholder="" type="text" onkeypress="return (event.charCode > 64 && event.charCode < 91) || (event.charCode > 96 && event.charCode < 123) || (event.charCode==32)" class="form-control"  value="<?php echo set_value('father_name'); ?>" />
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <input id="father_phone" name="father_phone" placeholder="" type="text" class="form-control" maxlength="10"   oninput="validateMobile('father_phone','sp_mobile2','btn')"  onkeypress="return (event.charCode > 47 && event.charCode < 58)"  value="<?php echo set_value('father_phone'); ?>" />
                                                <span class="text-danger"><?php echo form_error('father_phone'); ?></span>
                                                    <span id="sp_mobile2" style="color:red"></span>
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="form-group">
                                    ...
                                    <div class="row">
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <input id="mother_name" name="mother_name" placeholder="" type="text" class="form-control"  onkeypress="return (event.charCode > 64 && event.charCode < 91) || (event.charCode > 96 && event.charCode < 123) || (event.charCode==32)" value="<?php echo set_value('mother_name'); ?>" />
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <input id="mother_phone" name="mother_phone" placeholder="" type="text" class="form-control"  oninput="validateMobile('mother_phone','sp_mobile3','btn')" maxlength="10"  onkeypress="return (event.charCode > 47 && event.charCode < 58)" value="<?php echo set_value('mother_phone'); ?>" />
                                                <span class="text-danger"><?php echo form_error('mother_phone'); ?></span>
                                                  <span id="sp_mobile3" style="color:red"></span>
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="form-group">
                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input id="guardian_name" name="guardian_name" placeholder="" type="text" class="form-control"  onkeypress="return (event.charCode > 64 && event.charCode < 91) || (event.charCode > 96 && event.charCode < 123) || (event.charCode==32)" value="<?php echo set_value('guardian_name'); ?>" />
                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input id="guardian_phone" name="guardian_phone" placeholder="" type="text" class="form-control" maxlength="10"  		oninput="validateMobile('guardian_phone','sp_mobile4','btn')"  onkeypress="return (event.charCode > 47 && event.charCode < 58)"  value="<?php echo set_value('guardian_phone'); ?>" />
                                                        <span class="text-danger"><?php echo form_error('guardian_phone'); ?></span>
                                                         <span id="sp_mobile4" style="color:red"></span>
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label for="exampleInputEmail1">
                                                    <!--<?php echo $this->lang->line('guardian_email'); ?>-->
                                                    Guardian Email
                                                </label>
                                                <input id="guardian_email" name="guardian_email" placeholder="" type="text" class="form-control" oninput="validateGmail('guardian_email','sp_email2','btn')" value="<?php echo set_value('guardian_email'); ?>" />
                                                <span class="text-danger"><?php echo form_error('guardian_email'); ?></span>
                                                    <span id="sp_email2" style="color:red"></span>
                                            </div>
                                            <div class="form-group">
                            ...
                            <div class="box-footer">
                                <button type="submit" id="btn" class="btn btn-info pull-right"><?php echo $this->lang->line('save'); ?></button>
                            </div>
                    </form>
                </div>               
            </div>
...
<script type="text/javascript">
    ...
    $(document).on('click', '.add_sibling', function () {
        ...
        if (student_id.length > 0) {
            $.ajax({
                type: "GET",
                url: base_url + "accountant/student/getStudentRecordByID",
     ...
     function validateMobile(field,msg,btn){
        ...
        var regpan = /[6789]{1}[0-9]{9}/;
           ...
           // valid mobile no
            ...
            sp1.innerHTML="Invalid Mobile Number";
            sp1.style.color="red";
         ...
         // validate gmail
     function validateGmail(field,msg,btn){
        var gmailVal = $("#"+field).val();
        var sp2 = document.getElementById(msg);
        var regpan2 = /[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,4}$/;
            if(regpan2.test(gmailVal)==true){
           // valid gmail 
            sp2.innerHTML=("");
            sp2.style.color="";
            document.getElementById(btn).disabled=false;
