...
@media screen and (max-width: 600px) {
   ...
   .custum-chart-width .chart-responsive #barChart{
        width:500px!important
      }
   .custum-chart-width .chart{
...
<div class="content-wrapper" style="min-height: 946px;">
    <section class="content">
        <div class="row">
            ...
            <div class="col-md-4 col-sm-6 col-xs-12">
                <div class="info-box">
                    <a href="<?php echo site_url('accountant/student/search/accountant') ?>">
        ...
        <div class="row">       
            <div class="col-md-12">               
                <div class="box box-primary">
                    ...
                    <div class="box-body custum-chart-width">
