            ...
            <div class="col-md-12">
                ...
                if (isset($student_due_fee)) {
                  ...
                  <tr>
                        <td colspan="3" style="padding-top:10px;padding-bottom:10px;width:10%"> 
                           <img src="https://www.designevo.com/res/templates/thumb_small/cute-green-leaves-and-children.webp" style="height:100px">
                        </td>
                        <td colspan="6" style="padding-top:10px; text-align: left;padding-bottom:10px;"> 
                          <h3 style="padding-bottom: 10px;margin-bottom:10px; text-align: center;">Gautam Buddh Mahavidyalaya
                            <br> Paliyo, Bangarmaa Unnao</h3>
                           
                        </td>
                        <td colspan="3" style="padding-top:10px;padding-bottom:10px;"> 
                          <span>  Receipt Date : 24/06/2022 </span>
                            <br>
               ...
               <tr style="text-align: center;">
                   ...
                   <td colspan="12" style="padding: 8px 0px;">
                    <span>Year :2021-2022</span>   
                    <span style="margin-left:2%;">Courses: B.A , M.A</span>
                   </td>
                ...
                <tr >
                    ...
                    <td colspan="5" style="padding:10px 5px;border-top:0px solid black;border-bottom:1px solid black;border-right:0px solid black; ">3654685
                    </td>
                </tr>
                <tr><td colspan="" style="padding:10px 5px;border-top:0px solid black;border-bottom:0px solid black;border-left:0px solid black;border-right:0px solid black; ">Fee Dues: </td></tr>
                ...
                <tr >
                    ...
                    <td colspan="5" style="padding:2px 5px;border-top:0px solid black;border-bottom:1px solid black;border-right:0px solid black; ">3654685
                    </td>
                </tr>
                 <tr >
                ...
                <tr style="padding-top:40px; ">
                    ...
                    <td colspan="6" style="padding-top:40px;text-align:right">
                        Accountant Sign
                  </td>
                </tr>
