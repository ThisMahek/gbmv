                                    ...
                                    if (empty($resultlist)) {
                                        ...
                                        foreach ($resultlist as $student) {
                                            ...
                                            <tr>
                                                ...
                                                <td class="pull-right">
                                                    <a  target="_blank"   href="<?php echo base_url(); ?>accountant/studentfee/addfee/<?php echo $student['id'] ?>" class="btn btn-info btn-xs" data-toggle="tooltip" title="" data-original-title="">
