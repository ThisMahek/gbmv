                            ...
                            <div class="col-md-12">
                                <form role="form" action="<?php echo site_url('accountant/studentfee/searchpayment') ?>" method="post" class="form-inline">
                                    ...
                                    <div class="form-group">
                                        <div class="col-sm-">
                                            <label>
                                                <!--<?php echo $this->lang->line('receiptno'); ?>-->
                                                Receipt No
                                            </label>
                            ...
                            <table class="table table-striped table-bordered table-hover example">
                                ...
                                <tbody>
                                    ...
                                    if (empty($feeList)) {
                                        ...
                                        <tr>
                                            <td>
                                               GBM<?php echo $feeList->id . "/" . $sub_invoice_id; ?>
                                            </td>
                                            <td>
                                            ...
                                            <td class="text text-right">
                                                <a target="_blank"  href="<?php echo base_url() ?>accountant/studentfee/addfee/<?php echo $feeList->student_id ?>/accountant" class="btn btn-primary btn-xs" data-toggle="tooltip" title="<?php echo $this->lang->line('view'); ?>" data-original-title="<?php echo $this->lang->line('view'); ?>">
