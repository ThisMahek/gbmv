    ...
    <head>
        ...
        <style type="text/css">
          body {
            ...
            .form-bottom { padding-bottom: 10px !important; background:white;}
                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4 col-sm-12 form-box">
                            <center>
                                 <img src="<?php echo base_url(); ?>/uploads/school_content/logo/<?php echo $this->setting_model->getSchoolLogo();?>" class="mt-3" style="width:100px;margin-top:20px">
                            ...
                            <div class="form-bottom">
                                ...
                                <form class="" action="<?php echo site_url('site/ufpassword') ?>" method="post">
                                    ...
                                    <div class="form-group" style="height: 0px;width: 0px;visibility: hidden;">
                                        ...
                                        <label class="radio-inline">
                                            <input  name="user[]" type="radio" checked value="accountant" <?php echo set_radio('user[]', 'accountant'); ?>>
                                            Accountant
                                        </label>
                                        <label class="radio-inline">
