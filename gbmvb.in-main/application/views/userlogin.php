...
<html lang="en">
    <head><meta http-equiv="Content-Type" content="text/html; charset=utf-8">
        ...
        <style type="text/css">
        body {
            background-image: url(https://gbmv.anshuwap.com/backend/usertemplate/assets/img/backgrounds/11.jpg)!important;
        }
                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4 col-sm-12 form-box">
                            <div class="form-top">
                                <center>
                                    <img src="<?php echo base_url(); ?>/uploads/school_content/logo/<?php echo $this->setting_model->getSchoolLogo();?>" class="logowidth">
                            ...
                            <div class="form-bottom" style="padding-bottom: 5px;">
                                ...
                                <form action="<?php echo site_url('site/login') ?>" method="post">
                                    ...
                                    <div class="form-group">
                                        <label class="sr-only" for="form-username">
                                            <?php echo $this->lang->line('username'); ?></label>
                                        <input type="text" name="username" value="anshuwap1@gmail.com" placeholder="<?php echo $this->lang->line('username'); ?>" class="form-username form-control" id="email"> <span class="text-danger"><?php echo form_error('username'); ?></span>
                                    </div>
                                    <div class="form-group">
                                        <label class="sr-only" for="form-password">Password</label>
                                        <input type="password" name="password" value="" placeholder="<?php echo $this->lang->line('password'); ?>" class="form-password form-control" id="password"> <span class="text-danger"><?php echo form_error('password'); ?></span>
                                    </div>
                                    <button type="submit" class="btn">
                                        <?php echo $this->lang->line('sign_in'); ?></button>
                                </form>
