...
class admin extends Admin_Controller {
    ...
    function dashboard() {
        ...
        //print_r($year_end_month);exit;
    //   echo $this->db->last_query();die();
        
        //echo "<script>console.log('".json_encode($getDepositeAmount)."')</script>";
        ...
        $data['month_collection'] = $month_collection;
         ...
         //print_r( $data['month_collection']);exit;
        ...
        while ($start_month <= $end) {
            ...
            //echo $this->db->last_query();die();
            //print_r($getDepositeAmount);exit;
            if ($return) {
                $s[] = $return;
            } else {
                $s[] = "0.00";
                ...
                foreach ($feecollection_array as $key => $value) {
                    ...
                    if ($value['date'] == $date) {
                     ...
                     //   $return_amount = $return_amount + $value['amount'] + $value['amount_fine'];
                        $return_amount = $return_amount + $value['amount'];
                    }
                }
