...
$this->form_validation->set_rules('guardian_address', 'Guardian Address', 'trim|required|xss_clean');
        ...
        if ($this->form_validation->run() == FALSE) 
        {
            ...
            if($type=='admin')
            redirect('student/create/admin');
             if($type=='accountant')
            redirect('student/create/accountant');
        }
    }
    ...
    function import($type="") {
        ...
        if ($this->form_validation->run() == FALSE) {
           ...
           // $this->session->set_flashdata('msg', '<div student="alert alert-success text-center">Students imported successfully</div>');
            ...
            redirect('student/search/admin');
            if($type=='accountant')
             redirect('student/search/accountant');
        }
    }
...
//$this->form_validation->set_rules('subject_id', 'Subject', 'trim|required|xss_clean');
$this->form_validation->set_rules('admission_date', 'Admission Date', 'trim|required|xss_clean');
//$this->form_validation->set_rules('admission_no', 'Admission No', 'trim|xss_clean|is_unique[students.admission_no]');
