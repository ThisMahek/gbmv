    ...
    function changepass() {
        ...
        if ($this->form_validation->run() == FALSE) {
            ...
            if ($query1) {
                ...
                if ($query2) {
              $data ['error_message2'] = "<div class='alert alert-success'>Password changed successfully</div>";
                ...
                $this->session->set_flashdata('error_msg', 'Invalid current password');
                   $data ['error_message2'] = "<div class='alert alert-danger'>Invalid current password</div>";
                $this->load->view('layout/accountant/header', $data);
                $this->load->view('accountant/change_password', $data);
                $this->load->view('layout/accountant/footer', $data);
            }
