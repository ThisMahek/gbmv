...
class category extends CI_Controller {
    ...
    function index() {
        ...
        $this->load->view('accountant/category/categoryList', $data);
    ...
    function view($id) {
        ...
        $this->load->view('layout/accountant/header', $data);
        $this->load->view('accountant/category/categoryShow', $data);
        $this->load->view('layout/accountant/footer', $data);
    ...
    function delete($id) {
        ...
        redirect('accountant/category/index');
    }
    ...
    function edit($id) {
        ...
        if ($this->form_validation->run() == FALSE) {
            $this->load->view('layout/accountant/header', $data);
            $this->load->view('category/accountant/categoryEdit', $data);
            $this->load->view('layout/accountant/footer', $data);
        } else {
            $data = array(
                'id' => $id,
