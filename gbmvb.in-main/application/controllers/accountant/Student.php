...
class Student extends CI_Controller {
    ...
    function index() {
        ...
        $this->load->view('accountant/student/studentList', $data);
    ...
    function studentreport() {
        ...
        if ($this->input->server('REQUEST_METHOD') == "GET") {
            $this->load->view('layout/accountant/header', $data);
            $this->load->view('accountant/student/studentReport', $data);
            $this->load->view('layout/accountant/footer', $data);
        } else {
    ...
    function view($id,$type="") {
        ...
        if($type=='admin')
        {
            $data['type_s']='admin';
        $this->load->view('layout/accountant/header', $data);
        $this->load->view('accountant/student/studentShow', $data);
        $this->load->view('layout/accountant/footer', $data);
        }
        if($type=='accountant')
        {
    ...
    function delete($id) {
        ...
        redirect('accountant/student/search');
    }
    ...
    function doc_delete($id, $student_id) {
        ...
        redirect('accountant/student/view/' . $student_id);
    }
...
$this->form_validation->set_rules('guardian_address', 'Guardian Address', 'trim|required|xss_clean');
        ...
        if ($this->form_validation->run() == FALSE) 
        {
            ...
            $data['type_s']='admin';
            $this->load->view('layout/accountant/header', $data);
            $this->load->view('accountant/student/studentCreate', $data);
            $this->load->view('layout/accountant/footer', $data);
            }
            ...
            redirect('accountant/student/create/accountant');
        }
    }
    ...
    function import($type="") {
        ...
        if ($this->form_validation->run() == FALSE) {
            if($type=="admin")
            {
                $data['type_s']='admin';
            $this->load->view('layout/accountant/header', $data);
            $this->load->view('accountant/student/import', $data);
            $this->load->view('layout/accountant/footer', $data);
            }
            if($type=="accountant")
            {
           ...
           // $this->session->set_flashdata('msg', '<div student="alert alert-success text-center">Students imported successfully</div>');
             ...
             redirect('accountant/student/search/accountant');
        }
    }
...
$this->form_validation->set_rules('guardian_address', 'Guardian Address', 'trim|required|xss_clean');
        ...
        if ($this->form_validation->run() == FALSE) {
            $this->load->view('layout/accountant/header', $data);
            $this->load->view('accountant/student/studentEdit', $data);
            $this->load->view('layout/accountant/footer', $data);
        } else {
            $class_id = $this->input->post('class_id');
            $section_id = $this->input->post('section_id');
          $subject_id = $this->input->post('subject_id');
            ...
            redirect('accountant/student/search/admin');
        }
    }
    ...
    function search($type="") {
        ...
        if ($this->input->server('REQUEST_METHOD') == "GET") 
        {
           ...
           $data['type_s']='admin';
            $this->load->view('layout/accountant/header', $data);
            $this->load->view('accountant/student/studentSearch', $data);
            $this->load->view('layout/accountant/footer', $data);
            }
             if($type=='accountant')
            {
    ...
    function uploadimage($id) {
        ...
        $data['id'] = $id;
        $this->load->view('layout/accountant/header', $data);
        $this->load->view('accountant/student/uploadimage', $data);
        $this->load->view('layout/accountant/footer', $data);
    }
