...
class Admin_model extends CI_Model {
    ...
    public function __construct() {
        ...
        // $this->image = $this->setting_model->getSchoolLogo();
    ...
    public function getExpensebyDay($date) {
        $sql = 'SELECT SUM(amount) as amount FROM expenses where date=' . $this->db->escape($date) .'and session_id= '.$this->current_session ;
//echo $sql;exit;
        $query = $this->db->query($sql);
        return $query->result_array();
    }
